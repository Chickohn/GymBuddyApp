...
//        UITabBar.appearance().barTintColor = UIColor(Color("tabs"))
//        UITabBar.appearance().unselectedItemTintColor = UIColor.black
//        UITabBar.appearance().tintColor = UIColor(Color("tabicon"))
...
//    }
    ...
    var body: some View {
        ...
        .toolbarBackground(Color("tabs"))
    }
//    func setupTabBarAppearance() {
//        // Customize the appearance of the tab bar
//        tabBar.barTintColor = UIColor(Color("tabs"))
//        tabBar.unselectedItemTintColor = UIColor.black
//        tabBar.tintColor = UIColor(Color("tabicon"))
